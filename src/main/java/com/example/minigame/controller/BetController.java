...
public class BetController {
    ...
    public ResponseEntity<LinkedList<GameUser>> betting(@RequestBody LinkedList<GameUser> gameUserList)
    {
        ...
        gameUserList = resultCalculService.calLev4(gameUserList);

        gameUserList = resultCalculService.calLev5(gameUserList);


        if(roundNum == 3) {
            gameUserList = resultCalculService.calLev6(gameUserList);
        }
